...
class m170822_023219_create_table_config extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%viMJHk_config}}', [
            ...
            [7, 'BACKEND_THEME', Config::TYPE_SELECT, '后台主题', 1, 'wonail/yii2-theme-adminlte:wonail/yii2-theme-adminlte', '后台主题风格', 1379122533, 1499840813, 1, 'wonail/yii2-theme-adminlte', 5, "required\r\nstring"],
            [8, 'FRONTEND_THEME', Config::TYPE_SELECT, '前台主题', 1, 'wonail/yii2-frontend-theme-basic:wonail/yii2-frontend-theme-basic', '前台主题风格', 1379122799, 1499840799, 1, 'wonail/yii2-frontend-theme-basic', 5, "required\r\nstring"],
