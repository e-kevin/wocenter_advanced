...
// 用户信息
$userInfo = Wc::$service->getAccount()->queryUser(['username', 'nickname', 'realname', 'signature'], Yii::$app->getUser()->id);
?>
    ...
    <div class="col-md-3">
        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
                <img src="<?= $directoryAsset ?>/img/user2-160x160.jpg" class="profile-user-img img-responsive img-circle" alt="User profile picture"/>

                <h3 class="profile-username text-center"><?= $userInfo['username'] ?></h3>

                <p class="text-muted text-center"><?= $userInfo['signature']; ?></p>
                ...
                <div class="active tab-pane" id="change-password">
                    <?php
                        ...
                        $form = ActiveForm::begin([
                            'action' => Url::toRoute(['/passport/security/change-password']),
                            'box' => false,
                        ]);
                    ?>
